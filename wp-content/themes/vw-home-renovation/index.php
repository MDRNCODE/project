    ...
    <?php
        ...
        <div class="row">
          ...
          <div id="our-services" class="services col-lg-8 col-md-8">
            <?php if( get_theme_mod( 'vw_home_renovation_blog_post_pagination_position','bottom') == 'top' || get_theme_mod( 'vw_home_renovation_blog_post_pagination_position','bottom') == 'both') { ?>
            ...
            ?>
            <?php if( get_theme_mod( 'vw_home_renovation_blog_post_pagination_position','bottom') == 'bottom' || get_theme_mod( 'vw_home_renovation_blog_post_pagination_position','bottom') == 'both') { ?>
              <?php if( get_theme_mod( 'vw_home_renovation_blog_pagination_hide_show',true) == 1) { ?>
                <div class="navigation">
                  <?php vw_home_renovation_blog_posts_pagination(); ?>
                  <div class="clearfix"></div>
