      ...
      <?php if( get_theme_mod( 'vw_home_renovation_toggle_postdate',true) == 1 || get_theme_mod( 'vw_home_renovation_toggle_author',true) == 1 || get_theme_mod( 'vw_home_renovation_toggle_comments',true) == 1 || get_theme_mod( 'vw_home_renovation_toggle_time',true) == 1) { ?>
        ...
        <?php if( get_theme_mod('vw_home_renovation_button_text','Read More') != ''){ ?>
          <div class="more-btn mt-4 mb-4">
            <a href="<?php the_permalink(); ?>"><?php echo esc_html(get_theme_mod('vw_home_renovation_button_text',__('Read More','vw-home-renovation')));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('vw_home_renovation_button_text',__('Read More','vw-home-renovation')));?></span></a><i class="fas fa-angle-right"></i>
          </div>
        <?php } ?>
    </article>
  </div>
