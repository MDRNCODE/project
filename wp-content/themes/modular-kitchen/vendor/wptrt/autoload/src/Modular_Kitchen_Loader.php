...
class Modular_Kitchen_Loader {
	 ...
	 * @return void
	 */
	public function modular_kitchen_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function modular_kitchen_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function modular_kitchen_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function modular_kitchen_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->modular_kitchen_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function modular_kitchen_load( $class ) {
